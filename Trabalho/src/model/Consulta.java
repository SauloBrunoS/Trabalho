...
public class Consulta {
    ...
    public Consulta(int data_dia, int data_mes, int data_ano, String horario_marcado, String estado_consulta, String cpf_medico, String cpf_paciente){ 	
    ...
    public Consulta(int data_dia, int data_mes, int data_ano, String horario_marcado, String horario_fim, String estado_consulta, String cpf_medico, String cpf_paciente){ 	
		this.data_dia=data_dia;
		this.data_mes=data_mes;
		this.data_ano=data_ano;
		this.horario_marcado = horario_marcado;
	...
	public Consulta(int data_dia, int data_mes, int data_ano, String horario_marcado,  String horario_fim, String estado_consulta, float valor_total, String cpf_medico, String cpf_paciente,  int numero_tratamento){ 	
		this.data_dia=data_dia;
		this.data_mes=data_mes;
		this.data_ano=data_ano;
		this.horario_marcado = horario_marcado;
