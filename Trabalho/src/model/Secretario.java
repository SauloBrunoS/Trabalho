...
public class Secretario {
  ...
  private String hora_final_expediente;
	...
	public Secretario(String CPF, String RG,int id_pessoa, String nome, String data_nascimento, String sexo, String endereco_rua, String endereco_numero, String endereco_CEP, String hora_inicio_expediente, String hora_final_expediente, float salario_total, String dias_que_trabalha){ 	
		this.nome=nome;
		this.CPF=CPF;
    this.RG=RG;
